# -*- coding: utf-8 -*-
"""從新北市門牌位置數值資料中篩選三芝區資料（代號65000210），填入行政區、去重並重新排序"""
import csv

input_path = r'c:\Users\user\Desktop\新北市\新北市門牌位置數值資料.csv'
output_path = r'c:\Users\user\Desktop\newtaipei\三芝區門牌位置數值資料.csv'

# 三芝區代碼
SANZHI_AREACODE = '65000210'
...
with open(input_path, 'r', encoding='utf-8') as infile:
    ...
    for row in reader:
        # 檢查第二欄（索引1）是否為三芝區代碼
        if len(row) >= 2 and row[1] == SANZHI_AREACODE:
            ...
            output_row = [areacode, '三芝區', road, lane, alley]
