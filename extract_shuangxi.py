# -*- coding: utf-8 -*-
"""從新北市門牌位置數值資料中篩選雙溪區資料（代號65000250），填入行政區、去重並重新排序"""
import csv
...
with open(input_path, 'r', encoding='utf-8') as infile:
    ...
    for row in reader:
        # 檢查第二欄（索引1）是否為雙溪區代碼
        if len(row) >= 2 and row[1] == SHUANGXI_AREACODE:
            ...
            output_row = [areacode, '雙溪區', road, lane, alley]
