# -*- coding: utf-8 -*-
"""從新北市門牌位置數值資料中篩選坪林區資料（代號65000200），填入行政區、去重並重新排序"""
import csv

input_path = r'c:\Users\user\Desktop\新北市\新北市門牌位置數值資料.csv'
output_path = r'c:\Users\user\Desktop\newtaipei\坪林區門牌位置數值資料.csv'

# 坪林區代碼
PINGLIN_AREACODE = '65000200'
...
with open(input_path, 'r', encoding='utf-8') as infile:
    ...
    for row in reader:
        # 檢查第二欄（索引1）是否為坪林區代碼
        if len(row) >= 2 and row[1] == PINGLIN_AREACODE:
            ...
            output_row = [areacode, '坪林區', road, lane, alley]
