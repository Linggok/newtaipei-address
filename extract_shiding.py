# -*- coding: utf-8 -*-
"""從新北市門牌位置數值資料中篩選石碇區資料（代號65000190），填入行政區、去重並重新排序"""
import csv

input_path = r'c:\Users\user\Desktop\新北市\新北市門牌位置數值資料.csv'
output_path = r'c:\Users\user\Desktop\newtaipei\石碇區門牌位置數值資料.csv'

# 石碇區代碼
SHIDING_AREACODE = '65000190'
...
with open(input_path, 'r', encoding='utf-8') as infile:
    ...
    for row in reader:
        # 檢查第二欄（索引1）是否為石碇區代碼
        if len(row) >= 2 and row[1] == SHIDING_AREACODE:
            ...
            output_row = [areacode, '石碇區', road, lane, alley]
