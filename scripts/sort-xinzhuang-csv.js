/**
 * 將 新莊區門牌路巷弄資料.csv 內同路名的地址依巷、弄從小到大排序
 * 執行：node scripts/sort-xinzhuang-csv.js
 */

const fs = require('fs');
const path = require('path');

const CSV_PATH = path.join(__dirname, '..', '新莊區門牌路巷弄資料.csv');
...
try {
  ...
  console.log('已排序 新莊區門牌路巷弄資料.csv，共', rows.length, '筆');
} catch (e) {
