# -*- coding: utf-8 -*-
"""從新北市門牌位置數值資料中篩選五股區資料（代號65000150），填入行政區、去重並重新排序"""
import csv

input_path = r'c:\Users\user\Desktop\新北市\新北市門牌位置數值資料.csv'
output_path = r'c:\Users\user\Desktop\newtaipei\五股區門牌位置數值資料.csv'

# 五股區代碼
WUGU_AREACODE = '65000150'
...
with open(input_path, 'r', encoding='utf-8') as infile:
    ...
    for row in reader:
        # 檢查第二欄（索引1）是否為五股區代碼
        if len(row) >= 2 and row[1] == WUGU_AREACODE:
            ...
            output_row = [areacode, '五股區', road, lane, alley]
