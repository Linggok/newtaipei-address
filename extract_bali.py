# -*- coding: utf-8 -*-
"""從新北市門牌位置數值資料中篩選八里區資料（代號65000230），填入行政區、去重並重新排序"""
import csv

input_path = r'c:\Users\user\Desktop\新北市\新北市門牌位置數值資料.csv'
output_path = r'c:\Users\user\Desktop\newtaipei\八里區門牌位置數值資料.csv'

# 八里區代碼
BALI_AREACODE = '65000230'
...
with open(input_path, 'r', encoding='utf-8') as infile:
    ...
    for row in reader:
        # 檢查第二欄（索引1）是否為八里區代碼
        if len(row) >= 2 and row[1] == BALI_AREACODE:
            ...
            output_row = [areacode, '八里區', road, lane, alley]
