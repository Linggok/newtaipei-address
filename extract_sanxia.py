# -*- coding: utf-8 -*-
"""從新北市門牌位置數值資料中篩選三峽區資料（代號65000090），填入行政區欄位、去重、重新排列"""
import csv

input_path = r'c:\Users\user\Desktop\新北市\新北市門牌位置數值資料.csv'
output_path = r'c:\Users\user\Desktop\newtaipei\三峽區門牌位置數值資料.csv'

# 三峽區代碼
SANXIA_AREACODE = '65000090'
...
with open(input_path, 'r', encoding='utf-8') as infile:
    ...
    rows = []
    for row in reader:
        if len(row) > idx_areacode and row[idx_areacode] == SANXIA_AREACODE:
